...
fprintf('%d-year discounted facility TCO:       %12.0f\n', ...
    analysis_horizon_years, tco_summary.discounted_facility_TCO);
fprintf('%d-year discounted cooling TCO:        %12.0f\n', ...
    analysis_horizon_years, tco_summary.discounted_cooling_TCO);
